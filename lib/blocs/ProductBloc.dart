  ...
  Stream<bool> get outCreated => _loadingController.stream;
   ...
   ProductBloc({this.categoryId,this.product}){
     if(product != null){
       ...
       /*como a lista de tamanhos ou de imagens é uma lista limitada, aqui
       * vamos sobrescrever o nosso ["images"] por uma lista de images*/
       unsavedData["images"] = List.of(product.data["images"]);
       unsavedData["sizes"] = List.of(product.data["sizes"]);

       _createdController.add(true);
     }else{
       /*caso seja clicado para adicionar o mapa estará vazio por isso
       * a inicialização manual dos dados do firebase
       * Nota: os nomes tem de ser iguais aos que foram colocados no firebase*/
       unsavedData={
         "title":null,
         "description":null,
         "price": null,
   ...
   /*as funções abaixo serão chamadas quando tentar criar um novo produto
   * sera passado no metodo onSaved da tela de ProductScreen
   * Para cada campo que seria validado vai ter uma função aqui*/
