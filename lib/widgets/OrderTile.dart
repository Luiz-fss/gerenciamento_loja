...
import 'package:gerenciamentolojavirtual/widgets/OrderHearder.dart';
...
class OrderTile extends StatelessWidget {
  ...
  final states = [
    "","Aguardando", "Em Preparação","Aguardando Entrega", "Entregue"
  ];
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Card(
        //ExpansionTile, Tile que ao clicado Expande
        child: ExpansionTile(
                    ...
                    children: <Widget>[
                      FlatButton(
                        onPressed: (){
                          ...
                          .document(order.data["clientId"]).collection("orders")
